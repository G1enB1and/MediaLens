...
class WindowLayoutPanelsMixin:
    ...
    def _build_layout(self) -> None:
        ...
        self.btn_use_ocr_accurate = QPushButton("OCR (Accurate)")
        self.btn_use_ocr_accurate.setObjectName("btnUseOcrAccurate")
        self.btn_use_ocr_accurate.setProperty("baseText", "OCR (Accurate)")
        self.btn_use_ocr_accurate.setCursor(Qt.CursorShape.PointingHandCursor)
        self.btn_use_ocr_accurate.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        self.btn_use_ocr_accurate.setSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Fixed)
        self.btn_use_ocr_accurate.clicked.connect(lambda: self._run_text_ocr("paddle_accurate"))
        ...
        ocr_button_layout.addWidget(self.btn_use_ocr_accurate)
