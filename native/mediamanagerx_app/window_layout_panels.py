...
class WindowLayoutPanelsMixin:
    ...
    def _build_layout(self) -> None:
        ...
        self.ocr_review_status_lbl = QLabel("")
        self.ocr_review_status_lbl.setObjectName("bulkTagEditorStatusLabel")
        self.ocr_review_status_lbl.setWordWrap(True)
        self.ocr_review_status_lbl.setAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
        self.ocr_review_status_lbl.setTextFormat(Qt.TextFormat.PlainText)
        self.ocr_review_status_lbl.setMinimumHeight(40)
        self.ocr_review_status_lbl.setMaximumHeight(40)
        self.ocr_review_status_lbl.setMinimumWidth(0)
        self.ocr_review_status_lbl.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        ocr_review_nav_layout.addWidget(self.ocr_review_status_lbl, 1, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
        ...
        self.ocr_review_prev_btn.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        ...
        self.ocr_review_next_btn.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        ...
        self.meta_tags.textChanged.connect(lambda: self._schedule_tag_list_rows_state_refresh())
        ...
        self.btn_save_tags.setFixedHeight(32)
        self.btn_save_tags.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        ...
        self.generate_tags_btn_row.setFixedHeight(32)
        self.generate_tags_btn_row.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        ...
        generate_tags_btn_layout.setSpacing(8)
        ...
        self.btn_generate_tags.setFixedHeight(32)
        self.btn_generate_tags.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        ...
        generate_tags_btn_layout.addWidget(self.btn_save_tags, 1)
        ...
        self.bulk_ocr_page = QWidget(self.bulk_pages_stack)
        self.bulk_ocr_page.setObjectName("bulkOcrPage")
        self.bulk_ocr_page.setMinimumWidth(0)
        self.bulk_ocr_page.setSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Expanding)
        bulk_ocr_page_layout = QVBoxLayout(self.bulk_ocr_page)
        bulk_ocr_page_layout.setContentsMargins(0, 0, 0, 0)
        bulk_ocr_page_layout.setSpacing(0)

        self.bulk_ocr_scroll_area = QScrollArea()
        self.bulk_ocr_scroll_area.setWidgetResizable(True)
        self.bulk_ocr_scroll_area.setMinimumWidth(0)
        self.bulk_ocr_scroll_area.setSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Expanding)
        self.bulk_ocr_scroll_area.setFrameShape(QFrame.Shape.NoFrame)
        self.bulk_ocr_scroll_area.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.bulk_ocr_scroll_area.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.bulk_ocr_scroll_area.setObjectName("bulkOcrEditorScrollArea")
        self.bulk_ocr_scroll_area.viewport().installEventFilter(self)

        self.bulk_ocr_scroll_container = QWidget(self.bulk_ocr_scroll_area)
        self.bulk_ocr_scroll_container.setObjectName("bulkOcrEditorScrollContainer")
        ...
        self.bulk_ocr_selection_lbl.setObjectName("bulkTagEditorSelectionLabel")
        self.bulk_ocr_selection_lbl.setWordWrap(True)
        self.bulk_ocr_right_layout.addWidget(self.bulk_ocr_selection_lbl)

        self.bulk_ocr_btn_select_all_gallery = QPushButton("Select All Files in Gallery")
        self.bulk_ocr_btn_select_all_gallery.setObjectName("bulkBtnSelectAllGallery")
        self.bulk_ocr_btn_select_all_gallery.setProperty("baseText", "Select All Files in Gallery")
        self.bulk_ocr_btn_select_all_gallery.setCursor(Qt.CursorShape.PointingHandCursor)
        self.bulk_ocr_btn_select_all_gallery.setMinimumWidth(0)
        self.bulk_ocr_btn_select_all_gallery.setSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Fixed)
        self.bulk_ocr_btn_select_all_gallery.clicked.connect(self._select_all_visible_gallery_items)
        self.bulk_ocr_right_layout.addWidget(self.bulk_ocr_btn_select_all_gallery)

        self.bulk_ocr_selected_files_lbl = QLabel("Selected Files:")
        self.bulk_ocr_selected_files_lbl.setObjectName("bulkTagEditorSelectedFilesLabel")
        self.bulk_ocr_right_layout.addWidget(self.bulk_ocr_selected_files_lbl)

        self.bulk_ocr_selected_files_list = BulkSelectedFilesListWidget()
        self.bulk_ocr_selected_files_list.setObjectName("bulkSelectedFilesList")
        self.bulk_ocr_selected_files_list.setSelectionMode(QAbstractItemView.SelectionMode.NoSelection)
        self.bulk_ocr_selected_files_list.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        self.bulk_ocr_selected_files_list.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.bulk_ocr_selected_files_list.setVerticalScrollMode(QAbstractItemView.ScrollMode.ScrollPerPixel)
        self.bulk_ocr_selected_files_list.setSpacing(4)
        ...
        self.bulk_ocr_status_lbl = StatusTextEdit("")
        self.bulk_ocr_status_lbl.setObjectName("bulkTagEditorStatusLabel")
        self._configure_status_text_widget(self.bulk_ocr_status_lbl)
        self.bulk_ocr_right_layout.addWidget(self.bulk_ocr_status_lbl)
        ...
        self.bulk_ocr_bottom_buttons.setMinimumWidth(0)
        ...
        self.bulk_ocr_btn_run_fast = QPushButton("Fast OCR")
        self.bulk_ocr_btn_run_fast.setObjectName("bulkBtnRunLocalAI")
        self.bulk_ocr_btn_run_fast.setProperty("baseText", "Fast OCR")
        self.bulk_ocr_btn_run_fast.setToolTip("Run fast OCR for all selected files")
        self.bulk_ocr_btn_run_fast.setCursor(Qt.CursorShape.PointingHandCursor)
        self.bulk_ocr_btn_run_fast.setMinimumWidth(0)
        self.bulk_ocr_btn_run_fast.setSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Fixed)
        self.bulk_ocr_btn_run_fast.clicked.connect(lambda checked=False: self._run_bulk_ocr_for_paths("paddle_fast"))
        bulk_ocr_bottom_layout.addWidget(self.bulk_ocr_btn_run_fast)
        self.bulk_ocr_btn_run_ai = QPushButton("AI OCR")
        self.bulk_ocr_btn_run_ai.setObjectName("bulkBtnRunLocalAI")
        self.bulk_ocr_btn_run_ai.setProperty("baseText", "AI OCR")
        self.bulk_ocr_btn_run_ai.setToolTip("Run AI OCR for all selected files")
        self.bulk_ocr_btn_run_ai.setCursor(Qt.CursorShape.PointingHandCursor)
        self.bulk_ocr_btn_run_ai.setMinimumWidth(0)
        self.bulk_ocr_btn_run_ai.setSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Fixed)
        self.bulk_ocr_btn_run_ai.clicked.connect(lambda checked=False: self._run_bulk_ocr_for_paths(self._bulk_ai_ocr_source()))
        bulk_ocr_bottom_layout.addWidget(self.bulk_ocr_btn_run_ai)
        self.bulk_ocr_btn_save = QPushButton("Save Changes to DB")
        self.bulk_ocr_btn_save.setObjectName("bulkBtnSaveMeta")
        self.bulk_ocr_btn_save.setProperty("baseText", "Save Changes to DB")
        self.bulk_ocr_btn_save.setToolTip("Save edited OCR text to the database")
        self.bulk_ocr_btn_save.setCursor(Qt.CursorShape.PointingHandCursor)
        self.bulk_ocr_btn_save.setMinimumWidth(0)
        self.bulk_ocr_btn_save.setSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Fixed)
        self.bulk_ocr_btn_save.clicked.connect(self._save_bulk_ocr_text_to_db)
        bulk_ocr_bottom_layout.addWidget(self.bulk_ocr_btn_save)
        self.bulk_ocr_btn_clear = QPushButton("Clear All OCR Text")
        self.bulk_ocr_btn_clear.setObjectName("bulkBtnClearTags")
        self.bulk_ocr_btn_clear.setProperty("baseText", "Clear All OCR Text")
        self.bulk_ocr_btn_clear.setToolTip("Clear OCR text for all selected files")
        self.bulk_ocr_btn_clear.setCursor(Qt.CursorShape.PointingHandCursor)
        self.bulk_ocr_btn_clear.setMinimumWidth(0)
        self.bulk_ocr_btn_clear.setSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Fixed)
        self.bulk_ocr_btn_clear.clicked.connect(self._clear_bulk_ocr_text)
        bulk_ocr_bottom_layout.addWidget(self.bulk_ocr_btn_clear)
        self.bulk_ocr_right_layout.addWidget(self.bulk_ocr_bottom_buttons)

        self.bulk_ocr_scroll_area.setWidget(self.bulk_ocr_scroll_container)
        bulk_ocr_page_layout.addWidget(self.bulk_ocr_scroll_area)

        self.bulk_pages_stack.addWidget(self.bulk_tags_page)
        self.bulk_pages_stack.addWidget(self.bulk_captions_page)
        self.bulk_pages_stack.addWidget(self.bulk_ocr_page)
    ...
    def _sync_tag_list_panel_visibility(self, refresh_contents: bool = True) -> None:
        ...
        if should_show:
            ...
            if refresh_contents:
                if was_visible:
                    self._schedule_tag_list_rows_state_refresh()
                else:
                    self.tag_list_empty_lbl.setText("Loading tag list...")
                    self.tag_list_empty_lbl.setVisible(True)
                    QTimer.singleShot(0, self._refresh_tag_list_panel)
