    ...
    def _update_native_styles(self, accent_str: str) -> None:
        ...
        if hasattr(self, "tag_list_panel"):
            companion_style = f"""
                ...
                QPushButton#bulkSelectedFileGenerateButton, QPushButton#bulkSelectedFileGenerateTagsButton, QPushButton#bulkSelectedFileSaveTagsButton, QPushButton#bulkSelectedFileGenerateDescriptionButton, QPushButton#bulkSelectedFileSaveDescriptionButton, QPushButton#bulkBtnRunLocalAI {{
                ...
                QPushButton#bulkSelectedFileGenerateButton:hover, QPushButton#bulkSelectedFileGenerateTagsButton:hover, QPushButton#bulkSelectedFileSaveTagsButton:hover, QPushButton#bulkSelectedFileGenerateDescriptionButton:hover, QPushButton#bulkSelectedFileSaveDescriptionButton:hover, QPushButton#bulkBtnRunLocalAI:hover {{
                    background-color: {Theme.get_btn_save_hover(accent)};
                    color: {"#000" if is_light else "#fff"};
                    border-color: {accent_str};
                }}
                QPushButton#bulkSelectedFileGenerateButton:disabled, QPushButton#bulkSelectedFileGenerateTagsButton:disabled, QPushButton#bulkSelectedFileSaveTagsButton:disabled, QPushButton#bulkSelectedFileGenerateDescriptionButton:disabled, QPushButton#bulkSelectedFileSaveDescriptionButton:disabled, QPushButton#bulkBtnRunLocalAI:disabled {{
                    background-color: {Theme.get_control_bg(accent)};
                    color: {text_muted};
