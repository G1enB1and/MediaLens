...
class ScannersSettingsPage(SettingsPage):
    ...
    def __init__(self, dialog: "SettingsDialog") -> None:
        ...
        for key, title, description in self.SCANNERS:
            ...
            ocr_scope_detected_radio = QRadioButton("Only Files with Text Detected")
            ocr_scope_all_radio = QRadioButton("All Files within folders listed above")
            ...
            source_header.setChecked(False)
            source_header.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonTextBesideIcon)
            source_header.setIcon(self._source_folder_section_icon(False))
            ...
            source_divider.setVisible(False)
            source_body = QWidget()
            source_body.setVisible(False)
            ...
            schedule_header.setChecked(False)
            schedule_header.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonTextBesideIcon)
            schedule_header.setIcon(self._source_folder_section_icon(False))
            ...
            schedule_divider.setVisible(False)
            schedule_body = QWidget()
            schedule_body.setVisible(False)
